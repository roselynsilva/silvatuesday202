...
public class MonsterEntity : SEEntity
{
        ...
        public void initialize(SEResourceCache rsc) {
                ...
                rsc.prepare_image("zombie3", "zombie3", w*0.20, h*0.30);
                rsc.prepare_image("game","game",get_scene_width(),get_scene_height());
               
                monster = add_sprite_for_image(SEImage.for_resource("zombie3"));
               ...
               public void tick (TimeVal time, double delta) {
                ...
                if(px1==MainScene.ptx&&py1==MainScene.pty) {
                        MainScene.bg = add_sprite_for_image(SEImage.for_resource("game"));
